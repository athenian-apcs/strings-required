...
public class MyTests {
    ...
    public void testIsPalindrome() {
        ...
        assertEquals(true, MyMain.isPalindrome("tacocat"), "Whether the string \"tacocat\" is a palindrome should return: true");
    ...
    public void testStringOrder() {
        assertEquals("applebanana", MyMain.stringOrder("apple", "banana"));
        assertEquals("applebanana", MyMain.stringOrder("banana", "apple"));
        assertEquals("bananacranberry", MyMain.stringOrder("cranberry", "banana"));
        assertEquals("appleBanana", MyMain.stringOrder("apple", "Banana"));
        assertEquals("appleCranberry", MyMain.stringOrder("Cranberry", "apple"));
    }

    @Test
    public void testHalfAdder() {
        assertEquals("sciuter", MyMain.halfAdder("computer","science"));
        assertEquals("fple", MyMain.halfAdder("apple","fig"));
        assertEquals("boana", MyMain.halfAdder("banana","boat"));
        assertEquals("crabapple", MyMain.halfAdder("crablike","pineapple"));
        assertEquals("hipbone", MyMain.halfAdder("trombone", "hippie"));
    }
}
